...
function displayPics() {
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: the rando constiable is now local to the while loop. the console.log command will not have access to the constiable or its value.
  console.log(viewed);
