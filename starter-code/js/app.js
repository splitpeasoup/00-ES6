...
function displayPics() {
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: the rando letiable is now local to the while loop. the console.log command will not have access to the letiable or its value.
  console.log(viewed);
